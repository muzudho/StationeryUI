...
StationeryLayoutEngine はページの Bounds から下部パネルを確保し、残りに panel の padding を適用して ContentBounds とする。本文の grid-layout は ContentBounds を使う。インスペクターの Bounds は本文の padding の外側に配置する。
