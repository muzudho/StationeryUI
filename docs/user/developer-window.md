...
??? `App_Data/dev-window.stationery-style.json`???????????????????

- `window.width` / `window.height`: ????????????1?16384 ??????? px?
- `windowPadding`: ???????????????
- `windowRows`: ??????????????????????`1rate` ??????????????
- `inspectorColumns`: ??????????????????????????

??????? `models`?`layouts`?`bindings` ???????? Id ???????????????????????????
`window` ?????????????????????????????????????

Debug ???????????????????Release?NuGet ???????????? `App_Data/dev-window.stationery-style.json` ??????????? DLL ????????????
`STATIONERYUI_DEV_WINDOW_STYLE_PATH` ???????????Debug?Release ??????????????
???????????????????????????????????
