...
新しい構想では、［スタイル設定ファイル］に［コントロール］への依存は廃止します。  
［コントロール］は、［レイアウトハンドル］を持つだけです。

新しい構想の bindings セクションは、［レイアウトのパス］の短縮名である［レイアウトハンドル］を定義するだけです。  
...
［ソルバー］は、［レイアウト・ハンドル］を使って［レイアウトツリー］の中の［レイアウトノード］を探し、  
そこから Bounds を計算する。
