...
public sealed record DeveloperViewState(string? SelectedPath, string[] CollapsedPaths, double SplitRatio = .4, bool Visible = true);
public sealed record DeveloperInspectionMessage(StationeryInspectionEntry[] Entries, long ShowSequence, DeveloperViewState? RestoreState);
